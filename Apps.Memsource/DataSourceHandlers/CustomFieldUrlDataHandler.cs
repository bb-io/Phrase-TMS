...
{
    public class CustomFieldUrlDataHandler(InvocationContext invocationContext) : PhraseInvocable(invocationContext), IAsyncDataSourceItemHandler
    {
            ...
            DataSourceContext context, CancellationToken cancellationToken)
        {
            ...
            request.AddQueryParameter("types", "URL");
