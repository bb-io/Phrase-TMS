...
public class CustomFieldDateDataHandler : BaseInvocable, IAsyncDataSourceHandler
{
    private IEnumerable<AuthenticationCredentialsProvider> Creds =>
        InvocationContext.AuthenticationCredentialsProviders;

    public CustomFieldDateDataHandler(InvocationContext invocationContext) : base(invocationContext)
    {
    }
